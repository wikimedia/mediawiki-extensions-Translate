	...
	public function showPage( TranslatablePage $page, array $sections ) {
		...
		foreach ( $sections as $s ) {
			...
			if ( $s->type === 'changed' ) {
				...
				$oldContent = ContentHandler::makeContent( $s->getOldText(), $this->getTitle() );
				$newContent = ContentHandler::makeContent( $s->getText(), $this->getTitle() );
		...
		if ( $page->getMarkedTag() !== false ) {
			...
			if ( $oldTemplate !== $newTemplate ) {
				...
				$oldContent = ContentHandler::makeContent( $oldTemplate, $this->getTitle() );
				$newContent = ContentHandler::makeContent( $newTemplate, $this->getTitle() );
