 ...
 * This class reads and writes only UTF-16 files.
 *
 * WORK IN PROGRESS STUB NO WORKY YET
 *
 * @ingroup FFS
 */
class AppleFFS extends SimpleFFS {
	...
	protected function writeReal( MessageCollection $collection ) {
		...
		return self::toUTF16( $data );
	}

	public static function fromUTF16( $data ) {
		return mb_convert_encoding( $data, "UTF-8", "UTF-16LE" );
	}

	public static function toUTF16( $str ) {
