...
$messages['en'] = array(
	...
	'translate-group-desc-tsint' => 'A message group for [[Translating:Intuition|Intuition]], the i18n system for [//toolserver.org Toolserver] tools (<span class="plainlinks">[[Translating talk:Intuition|support]]</span>)',
...
$messages['qqq'] = array(
	...
	'translate-group-desc-pywikipedia' => 'Do not translate the link target <code>Translating:Pywikibot</code>.',
...
Pogledajte [http://unicode.org/repos/cldr-tmp/trunk/diff/supplemental/language_plural_rules.html#{{UILANGCODE}} Unicode CLDR stranicu za objašnjenje o ključevima množine].',
	...
	'translate-group-desc-tsint' => 'Grupa poruka za [http://toolserver.org/~krinkle/TsIntuition Toolserver Intuition], i18n sistem za [http://toolserver.org Toolserver] alate (<span class="plainlinks">[[Translating talk:Toolserver|podrška]] &middot; [https://wiki.toolserver.org/view/Toolserver_Intuition tehnički detalji]</span>)', # Fuzzy
...
$messages['ja'] = array(
	...
	'translate-group-desc-mediawikimostused' => 'このメッセージ群は、[[Translating:MediaWiki|MediaWiki]] で[http://translatewiki.net/wiki/Most_often_used_messages_in_MediaWiki もっともよく使われている 500 のメッセージ]を含んでいます',
	'translate-group-desc-mediawikiextensions' => 'サポート対象の [[Translating:MediaWiki|MediaWiki]] 拡張機能のすべてのメッセージを含む上位メッセージ群',
	'translate-group-desc-collection' => 'MediaWiki 拡張機能 [http://www.mediawiki.org/wiki/Extension:Collection Collection] のすべてのメッセージを含む上位メッセージ群',
	'translate-group-desc-flaggedrevs' => 'MediaWiki 拡張機能 [http://www.mediawiki.org/wiki/Extension:FlaggedRevs FlaggedRevs] のすべてのメッセージを含む上位メッセージ群',
	'translate-group-desc-readerfeedback' => 'MediaWiki 拡張機能 [http://www.mediawiki.org/wiki/Extension:ReaderFeedback ReaderFeedback] のすべてのメッセージを含む上位メッセージ群',
	'translate-group-desc-semantic' => '[http://semantic-mediawiki.org/ Semantic MediaWiki] 拡張機能のすべてのメッセージを含む上位メッセージ群',
	'translate-group-desc-translate' => 'MediaWiki 拡張機能 [http://www.mediawiki.org/wiki/Extension:Translate Translate] のすべてのメッセージを含む上位メッセージ群。この拡張機能の[//www.mediawiki.org/wiki/Help:Extension:Translate/Glossary 用語集]を参照して用語を把握してください。',
	'translate-group-desc-wikiaextensions' => '[http://www.wikia.com Wikia] で使用されている MediaWiki 拡張機能によってサポートされた、すべてのメッセージからなる上位メッセージ群',
	'translate-group-desc-wikimediaextensions' => '[http://wikimedia.org/ ウィキメディア財団]が使用している、サポート対象の MediaWiki 拡張機能のすべてのメッセージを含む上位メッセージ群',
	...
	'translate-group-desc-ui' => '[http://meta.wikimedia.org/wiki/Wikipedia_Usability_Initiative ウィキペディアのユーザビリティ改善]に関連した拡張機能のすべてのメッセージを含む上位メッセージ群',
	...
	'bw-desc-mwlibrl' => '[[Translating:Mwlib.rl|Mwlib.rl]] は、MediaWiki のページから PDF 文書を作成するためのライブラリです',
	...
	'bw-desc-wikireader' => '[[Translating:WikiReader|WikiReader]] は、携帯機器で、オフラインかつ文字のみのウィキペディアを提供します',
...
$messages['ko'] = array(
	...
	'translate-group-desc-semantic' => '모든 [http://semantic-mediawiki.org/ 시맨틱 미디어위키] 확장 기능의 모든 메시지를 포함하는 메타 그룹입니다.',
	...
	'translate-group-desc-tsint' => '[http://toolserver.org Toolserver] 도구에 대한 i18n 시스템인 [http://toolserver.org/~krinkle/TsIntuition Toolserver Intuition]에 대한 메시지 그룹입니다 (<span class="plainlinks">[[Translating talk:Toolserver|지원 요청]] &middot; [https://wiki.toolserver.org/view/Toolserver_Intuition 기술 사항]</span>)', # Fuzzy
...
$messages['nl'] = array(
	...
	'bw-desc-mwlibrl' => "[[Translating:Mwlib.rl|Mwlib.rl]] is een bibliotheek voor het maken van pdfdocumenten van MediaWiki-pagina's",
...
Oglejte si [http://unicode.org/repos/cldr-tmp/trunk/diff/supplemental/language_plural_rules.html#{{UILANGCODE}} stran Unicode CLDR za razlago množinskih ključev].',
	...
	'translate-group-desc-tsint' => 'Skupina sporočil za [[Translating:Intuition|Intuicijo]], sistem i18n za orodja [//toolserver.org Toolserver] (<span class="plainlinks">[[Translating talk:Intuition|podpora]]</span>)',
...
$messages['sr-el'] = array(
	...
	'translate-group-desc-pywikipedia' => '[[Translating:Pywikibot|Pajvikipedija]] je zbirka alatki za uređivanje Vikipedije', # Fuzzy
...
更多信息請見[[mw:Extension:PDF_Writer]]和http://code.pediapress.com/wiki/wiki/mwlibrl。", # Fuzzy
	...
	'translate-group-desc-pywikipedia' => '[[Translating:Pywikibot|Pywikibot]]是一個維基百科編輯工具集合。',
	'bw-desc-shapado' => '本組包含免費開源問答軟件[[Translating:Shapado|Shapado]]的信息',
	'translate-group-desc-tsint' => '[http://toolserver.org Toolserver]工具的國際化系統，[http://toolserver.org/~krinkle/TsIntuition Toolserver Intuition]的消息組（<span class="plainlinks">[[Translating talk:Toolserver|幫助]] &middot; [https://wiki.toolserver.org/view/Toolserver_Intuition 技術細節]</span>）', # Fuzzy
