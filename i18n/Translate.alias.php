...
$specialPageAliases['zh'] = [
	...
	'ManageMessageGroupSubscriptions' => [ 'ManageMessageGroupSubscriptions' ],
	'ManageMessageGroups' => [ 'ManageMessageGroups' ],
	'ManageTranslatorSandbox' => [ 'ManageTranslatorSandbox' ],
	'MessageGroupStats' => [ 'MessageGroupStats' ],
	'PageTranslation' => [ 'PageTranslation' ],
	'PageTranslationDeletePage' => [ 'PageTranslationDeletePage' ],
	'SearchTranslations' => [ 'SearchTranslations' ],
...
$specialPageAliases['zh-hant'] = [
	...
	'LanguageStats' => [ '語言統計' ],
	'ManageMessageGroupSubscriptions' => [ '管理訊息群組訂閲' ],
	'ManageMessageGroups' => [ '管理訊息群組' ],
	'ManageTranslatorSandbox' => [ '管理翻譯人員沙盒', '翻譯人員沙盒' ],
	'MessageGroupStats' => [ '訊息群組統計' ],
	'PageTranslation' => [ '頁面翻譯' ],
	'PageTranslationDeletePage' => [ '頁面翻譯刪除頁面' ],
	'SearchTranslations' => [ '搜尋翻譯' ],
	'SupportedLanguages' => [ '活躍的語言', '受支援的語言', '支援的語言' ],
	'Translate' => [ '翻譯' ],
	'TranslationStash' => [ '翻譯儲藏庫' ],
	'TranslationStats' => [ '翻譯統計' ],
	'Translations' => [ '翻譯清單' ],
	'PageMigration' => [ '頁面遷移', '頁面轉移' ],
