...
class ApiQueryManageMessageGroups extends ApiQueryBase {
	...
	public function execute() {
		...
		$msgKey = $params['key'];
		$name = empty( $params['grouptype'] ) ?
			MessageChangeStorage::DEFAULT_NAME : $params['grouptype'];
	...
	protected function getPossibleRenames( MessageSourceChange $sourceChanges, $groupNamespace,
		...
		$targetMsg = $sourceChanges->findMessage( $languageCode,  $msgKey, $msgState,
	...
	protected function getExamplesMessages() {
		return [
			'action=query&meta=managemessagegroup&mmggroup=hello&mmglanguage=en
				&mmggrouptype=default&mmgkey=world' => 'apihelp-managemessagegroup-example-1',
		];
	}
}
