...
GROOVY;
	 ...
	 * @param \Elastica\Query\AbstractQuery $baseQuery the query
	 */
	 ...
	 */
	public static function iterateOverScroll( \Elastica\Type $type, $scrollId, $scrollTime, $consumer, $limit = 0, $retryAttempts = 0, $retryErrorCallback = null ) {
		$clearScroll = true;
		$fetched = 0;
