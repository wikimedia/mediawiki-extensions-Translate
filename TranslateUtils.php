...
class TranslateUtils {
	 ...
	 * @param array $extraFields List of extra columns to fetch.
	 * @return array List of recent changes.
	 */
	public static function translationChanges( $hours = 24, $bots = false, $ns = null, $extraFields = [] ) {
		...
		$fields = array_merge( ['rc_title', 'rc_timestamp', 'rc_user_text', 'rc_namespace'], $extraFields );
