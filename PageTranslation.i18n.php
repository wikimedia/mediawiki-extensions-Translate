...
$messages['en'] = array(
	...
	'tpt-oldrevision' => '$2 is not the latest version of the page $1. Only latest versions can be marked up for translating.',
	'tpt-notsuitable' => 'Page $1 is not suitable for translation. Please make sure it has <nowiki><translate></nowiki>-tags and has a valid syntax.',
	'tpt-saveok' => '$1 has been marked up for translation with $2 translatable sections. The page can now be <span class="plainlinks">[$3 translated]</span>.',
	'tpt-badsect' => '"$1" is not a valid name for section $2.',
	'tpt-deletedsections' => 'The following sections wil no longer be used',
	'tpt-showpage-intro' => 'Below are listed new, existing and deleted sections. Before marking this version for translation, please check that the changes to sections are minimised to avoid unnecessary work for translations.',
	...
	'tpt-target-page' => 'This page cannot be updated manually. This page is a translation of page [[$1]] and the translation can be updated using [$2 the translation tool].',
	'tpt-unknown-page' => 'This namespace is reserved for content page translations. The page you are trying to edit does not seem to correspond any page marked for translation.'
);