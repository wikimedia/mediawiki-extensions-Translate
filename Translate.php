...
#'ext-makebot'               => 'MakeBotMessageGroup', # about to become obsolete pending Userrights interface clean up
#'ext-makesysop'             => 'MakeSysopMessageGroup', # about to become obsolete pending Userrights interface clean up
