( function ( $, mw ) {
	...
	TranslateEditor.prototype = {
		...
		/**
		 * Get the API for saving the translation.
		 * @param {string} source The translation source, the title of the message.
		 * @param {string} translation The translation of the message
		 * @return {jQuery.Deferred}
		 */
		saveAPI: function ( source, translation ) {
