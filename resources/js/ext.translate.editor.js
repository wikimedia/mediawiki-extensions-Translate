( function ( $, mw, autosize ) {
	...
	TranslateEditor.prototype = {
		...
		createMessageTools: function () {
			var $editItem, $historyItem, $deleteItem, $translationsItem, editAction;

			editAction = this.message.translation === null ? 'create' : 'edit';
			$editItem = this.createMessageToolsItem(
				...
				// tux-editor-message-tools-create, tux-editor-message-tools-edit
				'tux-editor-message-tools-' + editAction
			);
