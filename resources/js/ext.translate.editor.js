( function ( $, mw ) {
	 ...
	 * For a translation unit(message), prepare an translation editor UI with
	 * all required actions.
	 * This is mainly used with message table plugin in pagemode mode.
	 ...
	 * the editor will appear as if the message is replaced by editor.
