( function ( $, mw ) {
	...
	TranslateEditor.prototype = {
		 ...
		 * @param {array} documentation array as returned by API.
		 */
		 ...
		 * @param {array} inotherlanguages array as returned by the translation helpers API.
		 */
		...
		/**
		 * Shows the message documentation.
		 * @param {array} suggestions ttmserver array as returned by API.
		 */
		 ...
		 * @param {object} support support object as returned by API.
		 */
		 ...
		 * @param {object} definitiondiff definitiondiff object as returned by API.
		 */
