	...
	TranslateMessageGroupSelector.prototype = {
		...
		showRecentGroups: function () {
			...
			this.loadRecentGroups()
				.then( $.proxy( this.loadMessageGroups, this ) );
		},

		/**
		 * Load message groups.
		 * @param {Array} groups: List of the message groups to be loaded.
		 */
		loadMessageGroups: function ( groups ) {
			var groupSelector = this;
