( function ( $, mw ) {
	 ...
	 */
	function createTranslationPage( title, content, summary ) {
		var api = new mw.Api();
	...
	function createPages() {
		...
		for ( i = 0; i < noOfSourceUnits; i++ ) {
			...
			// Not sure how to synchronize these calls. Not allowed to write
			// a callback function inside a for loop.
			createTranslationPage( title, content, summary );
		}
		$( '#buttonImport' ).show();
	}
