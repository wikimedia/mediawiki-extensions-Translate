...
When(/^I click on the username of a user who didn't make any translations in the first column$/) do
	on(ManageTranslatorSandboxPage).request_with_username("Orava0").click
end
