...
$wgTranslateMessages['kk-kz'] = array(
	...
	'translate-edit-message-in' => 'Ағымдағы жол <b>$1</b> ($2) дегенде:',
	'translate-edit-message-in-fb' => 'Ағымдағы жол <b>$1</b> ($2) деген сүйену тілінде:',
	'translate-choose-settings' => 'Баптауыңызды таңдаңыз. Аңғартпа: Барлық ұйытқы хабарларды келтіру нәтижесі өте үлкен кесте болады және де бет мөлшері 100 KB асады!',
...
$wgTranslateMessages['kk-tr'] = array(
	...
	'translate-edit-message-in' => 'Ağımdağı jol <b>$1</b> ($2) degende:',
	'translate-edit-message-in-fb' => 'Ağımdağı jol <b>$1</b> ($2) degen süýenw tilinde:',
	'translate-choose-settings' => 'Baptawıñızdı tañdañız. Añğartpa: Barlıq uýıtqı xabarlardı keltirw nätïjesi öte ülken keste boladı jäne de bet mölşeri 100 KB asadı!',
	'translate-language'  => 'Til:',
);
$wgTranslateMessages['kk-cn'] = array(
	'translate' => 'اۋدارۋ',
	'translate-show-label' => 'كٴورسەتۋ:',
	'translate-opt-review' => 'شولۋ تٴارتٴىبٴىمەن',
	'translate-opt-trans' => 'تەك اۋدارىلماعانداردى',
	'translate-opt-optional' => 'مٴىندەتتٴى ەمەستەردٴى',
	'translate-opt-changed' => 'تەك ٴوزگەرگەندەردٴى',
	'translate-opt-ignored' => 'ەلەمەلٴىنگەندەردٴى',
	'translate-opt-database' => 'تەك دەرەكقورداعىلاردى',
	'translate-messageclass' => 'حابار تابى:',
	'translate-sort-label' => 'سۇرىپتاۋى:',
	...
	'translate-edit-message-format' => 'بۇل حاباردىڭ پٴىشٴىمٴى - <b>$1</b>.',
	'translate-edit-message-in' => 'اعىمداعى جول <b>$1</b> ($2) دەگەندە:',
	'translate-edit-message-in-fb' => 'اعىمداعى جول <b>$1</b> ($2) دەگەن سٴۇيەنۋ تٴىلٴىندە:',
	'translate-choose-settings' => 'باپتاۋىڭىزدى تاڭداڭىز. اڭعارتپا: بارلىق ۇيىتقى حابارلاردى كەلتٴىرۋ نٴاتيجەسٴى ٴوتە ٴۇلكەن كەستە بولادى جٴانە دە بەت مٴولشەرٴى 100 KB اسادى!',
	'translate-language'  => 'تٴىل:',
);
