...
class SpecialImportTranslations extends SpecialPage {
	...
	public function execute( $parameters ) {
		...
		if ( !$this->getUser()CanExecute( $this->getUser() ) ) {
	...
	protected function outputForm() {
		...
		$this->getOutput()->addHTML(
			Xml::radioLabel( $this->msg( 'translate-import-from-url' )->plain(),
		...
		$this->getOutput()->addHTML(
			Xml::radioLabel( $this->msg( 'translate-import-from-wiki' )->plain(),
			...
			"\n" . Xml::closeElement( 'td' ) . Xml::closeElement( 'tr' ) .
			Xml::openElement( 'tr' ) . Xml::openElement( 'td' ) . "\n" .
			Xml::radioLabel( $this->msg( 'translate-import-from-local' )->plain(),
			...
			Xml::submitButton( $this->msg( 'translate-import-load' )->plain() ) .
