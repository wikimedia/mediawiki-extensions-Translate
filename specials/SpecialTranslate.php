...
class SpecialTranslate extends SpecialPage {
	...
	public function execute( $parameters ) {
		...
		if ( $this->task->plainOutput() ) {
			...
			if ( $description ) {
				$description = Xml::fieldset( $this->msg( 'translate-page-description-legend' )->plain(), $description );
			}
	...
	protected function settingsForm( $errors ) {
		...
		$button = Xml::submitButton( $this->msg( 'translate-submit' )->plain() );

		$form =
			Html::openElement( 'fieldset', array( 'class' => 'mw-sp-translate-settings' ) ) .
				Html::element( 'legend', null, $this->msg( 'translate-page-settings-legend' )->plain() ) .
	...
	protected function doStupidLinks() {
		...
		return
			Html::openElement( 'fieldset' ) .
				Html::element( 'legend', null, $this->msg( 'translate-page-navigation-legend' )->plain() ) .
				$navigation .
			Html::closeElement( 'fieldset' );
	}
