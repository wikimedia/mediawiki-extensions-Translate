...
class SpecialTranslationStats extends SpecialPage {
	...
	public function draw( FormOptions $opts ) {
		...
		$plot->SetFontTTF( 'generic', $font, 8 * $imageScale );
		$plot->SetFontTTF( 'legend', $font, 8 * $imageScale );
		$plot->SetFontTTF( 'x_title', $font, 14 * $imageScale );
		$plot->SetFontTTF( 'y_title', $font, 14 * $imageScale );
		$plot->setFontTTF( 'x_label', $numberFont, 6 * $imageScale );
		$plot->setFontTTF( 'y_label', $numberFont, 6 * $imageScale );
