...
class SpecialLanguageStats extends IncludableSpecialPage {
	...
	protected function getForm() {
		...
		$out .= Html::element( 'legend', null, $this->msg( 'translate-language-code' )->plain() );
		$out .= Html::openElement( 'table' );

		$out .= Html::openElement( 'tr' );
		$out .= Html::openElement( 'td', array( 'class' => 'mw-label' ) );
		$out .= Xml::label( $this->msg( 'translate-language-code-field-name' )->plain(), 'language' );
		...
		$out .= Xml::checkLabel( $this->msg( 'translate-suppress-complete' )->plain(), 'suppresscomplete', 'suppresscomplete', $this->noComplete );
		$out .= Html::closeElement( 'td' );
		$out .= Html::closeElement( 'tr' );

		$out .= Html::openElement( 'tr' );
		$out .= Html::openElement( 'td', array( 'colspan' => 2 ) );
		$out .= Xml::checkLabel( $this->msg( 'translate-ls-noempty' )->plain(), 'suppressempty', 'suppressempty', $this->noEmpty );
		$out .= Html::closeElement( 'td' );
		$out .= Html::closeElement( 'tr' );

		$out .= Html::openElement( 'tr' );
		$out .= Html::openElement( 'td', array( 'class' => 'mw-input', 'colspan' => 2 ) );
		$out .= Xml::submitButton( $this->msg( 'translate-ls-submit' )->plain() );
		$out .= Html::closeElement( 'td' );
		$out .= Html::closeElement( 'tr' );
