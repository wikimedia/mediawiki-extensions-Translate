...
class SpecialPageMigration extends SpecialPage {
	...
	function execute( $par ) {
		...
		$out .= Html::element( 'input', array( 'id' => 'mw-tpm-sp-pageinput_button-import', 'type' => 'button',
			'value' => $this->msg( 'pm-import-button-label' )->text() ) );
		$out .= Html::element( 'input', array( 'id' => 'mw-tpm-sp-pageinput_button-save', 'type' => 'button',
			'value' => $this->msg( 'pm-savepages-button-label' )->text() ) );
		$out .= Html::element( 'input', array( 'id' => 'mw-tpm-sp-pageinput_button-cancel', 'type' => 'button',
