...
class SpecialPageMigration extends SpecialPage {
	...
	function execute( $par ) {
		...
		$out .= Html::openElement( 'input', array( 'id' => 'pagename', 'type' => 'text',
													'placeholder' => 'Enter page name' ) );
		$out .= Html::openElement( 'input', array( 'id' => 'langcode', 'type' => 'text',
													'placeholder' => 'langcode' ) );
		$out .= Html::openElement( 'input', array( 'id' => 'buttonImport', 'type' => 'submit',
													'value' => 'Import' ) );
