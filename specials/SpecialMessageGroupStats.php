...
class SpecialMessageGroupStats extends SpecialLanguageStats {
	...
	function getform() {
		...
		$out .= Html::element( 'legend', null, $this->msg( 'translate-mgs-fieldset' )->escaped() );
		$out .= Html::openElement( 'table' );

		$out .= Html::openElement( 'tr' );
		$out .= Html::openElement( 'td', array( 'class' => 'mw-label' ) );
		$out .= Xml::label( $this->msg( 'translate-mgs-group' )->escaped(), 'group' );
		...
		$out .= Xml::checkLabel( $this->msg( 'translate-mgs-nocomplete' )->escaped(), 'suppresscomplete', 'suppresscomplete', $this->noComplete );
		$out .= Html::closeElement( 'td' );
		$out .= Html::closeElement( 'tr' );

		$out .= Html::openElement( 'tr' );
		$out .= Html::openElement( 'td', array( 'colspan' => 2 ) );
		$out .= Xml::checkLabel( $this->msg( 'translate-mgs-noempty' )->escaped(), 'suppressempty', 'suppressempty', $this->noEmpty );
		$out .= Html::closeElement( 'td' );
		$out .= Html::closeElement( 'tr' );

		$out .= Html::openElement( 'tr' );
		$out .= Html::openElement( 'td', array( 'class' => 'mw-input', 'colspan' => 2 ) );
		$out .= Xml::submitButton( $this->msg( 'translate-mgs-submit' )->escaped() );
		$out .= Html::closeElement( 'td' );
		$out .= Html::closeElement( 'tr' );
