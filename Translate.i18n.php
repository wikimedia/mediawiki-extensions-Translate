...
$messages['kk-arab'] = array(
	...
	'translate-page-no-such-task'       => 'ەنگٸزٸلگەن تاپسىرما جارامسىز.',
	'translate-page-no-such-group'      => 'ەنگٸزٸلگەن توب جارامسىز.',
	'translate-page-settings-legend'    => 'باپتاۋ',
	'translate-page-task'               => 'تالابىم:',
	'translate-page-group'              => 'حابار توبى',
	'translate-page-language'           => 'تٸلٸ',
	'translate-page-limit'              => 'شەكتەمٸ',
	'translate-page-limit-option'       => 'بەت سايىن  {{PLURAL:$1|1|$1}} حابار',
	'translate-submit'                  => 'كەلتٸر!',
	'translate-page-navigation-legend'  => 'باعىتتاۋ',
	'translate-page-showing'            => 'كٶرسەتٸلگەن حابار اۋقىمى: $1 - $2 (نە بارلىعى $3).',
	'translate-page-showing-all'        => 'كٶرسەتٸلۋٸ: {{PLURAL:$1|1|$1}} حابار.',
	'translate-page-showing-none'       => 'كٶرسەتٸلەتٸن ەش حابار جوق.',
	'translate-next'                    => 'كەلەسٸ بەت',
	'translate-prev'                    => 'الدىڭعى بەت',
	'translate-page-description-legend' => 'بۇل توپ تۋرالى مٵلٸمەت',
	'translate-optional'                => '(مٸندەتتٸ ەمەس)',
	'translate-ignored'                 => '(ەلەمەيتٸن)',
	'translate-edit-definition'         => 'حاباردىڭ انىقتالىمى',
	'translate-edit-contribute'         => 'ٷلەس بەر',
	'translate-edit-no-information'     => "''بۇل حابار قۇجاتتاماسىز. ەگەر وسى حاباردىڭ قايدا نەمەسە قالاي قولدانعانىن بٸلسەڭٸز, بۇل حابارعا قۇجاتتاما كەلتٸرٸپ, باسقا اۋدارۋشىلارعا كٶمەكتەسە الاسىز.''",
	'translate-edit-information'        => 'بۇل حابار تۋرالى مٵلٸمەت ($1)',
	'translate-edit-in-other-languages' => 'حابار باسقا تٸلدەردە',
...
ەسٸم ايا اۋدارمالارىندا <tt>$1_talk</tt> دەگەن ارنايى كەلتٸرٸلەدٸ. <tt>$1</tt> دەگەن اينالمالى ٶزدٸكتٸك توراپ اتاۋىمەن الماستىرىلادى (مىسالى, <tt>{{SITENAME}} تالقىلاۋى</tt>). ەگەر سٸزدٸڭ تٸلٸڭٸزدە توراپ اتاۋىن ٶزگەرتپەي دۇرىس سٶيلەم قۇرىلماسا, دامىتۋشىلارعا حابارلاسىڭىز.',
	...
	'translate-magic-cm-to-be'          => 'بولۋعا تيٸستٸسٸ',
	...
	'translate-checks-parameters'       => 'كەلەسٸ باپتالىمدار پايدالانىلماعان: <strong>$1</strong>',
	'translate-checks-balance'          => 'مىندا جاقشالاردىڭ بارلىق سانى جۇپ ەمەس: <strong>$1</strong>',
	'translate-checks-links'            => 'كەلەسٸ سٸلتەمەلەر جارامسىز: <strong>$1</strong>',
	'translate-checks-xhtml'            => 'كەلەسٸ بەلگٸلەمەلەردٸ دۇرىستارىمەن الماستىرىڭىز: <strong>$1</strong>',
	'translate-checks-plural'           => 'انىقتالىمدا <nowiki>{{PLURAL:}}</nowiki> پايدالانىلعان, بٸراق اۋدارمادا بۇل جوق.',
);
